...
import type { MembershipType as _MembershipType, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async selectMembershipType(arg0: MembershipType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.selectMembershipType(to_candid_MembershipType_n13(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_MembershipType_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MembershipType): MembershipType {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        membershipType: from_candid_MembershipType_n7(_uploadFile, _downloadFile, value.membershipType)
    };
}
...
function from_candid_variant_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "normal" in value ? MembershipType.normal : "premium" in value ? MembershipType.premium : "none" in value ? MembershipType.none : "simple" in value ? MembershipType.simple : value;
}
function to_candid_MembershipType_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MembershipType): _MembershipType {
...
function to_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        membershipType: to_candid_MembershipType_n13(_uploadFile, _downloadFile, value.membershipType)
    };
}
function to_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MembershipType): {
    normal: null;
} | {
    premium: null;
} | {
    ...
    return value == MembershipType.normal ? {
        normal: null
    } : value == MembershipType.premium ? {
        premium: null
    } : value == MembershipType.none ? {
        none: null
